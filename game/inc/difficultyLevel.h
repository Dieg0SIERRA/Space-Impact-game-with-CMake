...
inline std::vector <std::vector<int>> matrixEnemies =
    {                        // score   #_Ast_1   hp_1   spd_1   new_ast  #_Ast_2   hp_2   spd_2   #_Ast_3   hp_3   spd_3   #_obst   spd_obst
                             ...
                             {80,      6,       1,     12,      7,       0,       0,     0,       0,       0,     0,      0,      0},
                             {90,      6,       1,     11,      7,       0,       0,     0,       0,       0,     0,      0,      0},
                             {100,     6,       1,     10,      6,       1,       2,     20,       0,       0,     0,      0,      0},
                             {110,     6,       2,     10,      6,       2,       2,     19,       0,       0,     0,      0,      0},
                             {120,     6,       2,     10,      6,      8,       2,     17,       0,       0,     0,      0,      0},
                             {130,     6,       2,     10,      6,      10,      2,     17,       0,       0,     0,      0,      0},
