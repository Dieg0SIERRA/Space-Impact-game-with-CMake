...
inline std::vector <std::vector<int>> matrixEnemies =
    {                        // score   num_Ast   hp_1   spd_1      size_1       new_ast  #_Ast_2   hp_2   spd_2   #_Ast_3   hp_3   spd_3   #_obst   spd_obst
                             ...
                             {10,      2,       1,     24,         4,         3,       0,       0,     0,        0,       0,     0,      0,      0},
                             {20,      3,       1,     22,         4,         4,       0,       0,     0,        0,       0,     0,      0,      0},
                             {30,      4,       1,     20,         3,         5,       0,       0,     0,        0,       0,     0,      0,      0},
                             {40,      5,       1,     18,         3,         6,       0,       0,     0,        0,       0,     0,      0,      0},
                             {50,      6,       1,     16,         4,         7,       0,       0,     0,        0,       0,     0,      0,      0},
                             {60,      6,       1,     14,         4,         7,       0,       0,     0,        0,       0,     0,      0,      0},
                             {70,      6,       1,     13,         2,         7,       0,       0,     0,        0,       0,     0,      0,      0},
                             {80,      6,       1,     12,         2,         7,       0,       0,     0,       0,       0,     0,      0,      0},
                             {90,      6,       1,     11,         1,         7,       0,       0,     0,       0,       0,     0,      0,      0},
                             {100,     6,       1,     10,         1,         6,       1,       2,     20,       0,       0,     0,      0,      0},
                             {110,     6,       2,     10,         1,         6,       2,       2,     19,       0,       0,     0,      0,      0},
                             {120,     6,       2,     10,         1,         6,      8,       2,     17,       0,       0,     0,      0,      0},
                             {130,     6,       2,     10,         1,         6,      10,      2,     17,       0,       0,     0,      0,      0},
                             {140,     0,       1,     14,         1,         7,      10,      2,     17,       1,       3,    17,      0,      0},
                             {150,     0,       1,     14,         1,         7,       8,       2,     14,       3,       3,    17,      0,      0},
                             {160,     0,       1,     14,         1,          7,       5,       2,     14,       6,       3,    17,      0,      0},
                             {170,     0,       1,     14,         2,          7,       5,       2,     11,       7,       3,    14,      0,      0},
                             {180,     0,       0,     14,         2,          7,       5,       2,     11,       7,       3,    14,      1,      17},
                             {419,     0,       0,     14,         2,          7,       4,       2,     11,       8,       3,    14,      3,      14},
                             {200,     0,       0,     14,         2,          7,       4,       2,     10,       8,       3,    14,      5,      11} };
